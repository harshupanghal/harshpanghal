...

  {
    ...
    icon: (
      <img
        ...
        alt="Hardhat"
        className="max-w-full max-h-full scale-[2.5] object-contain"
      />
    ),
  },
...

  {
    ...
    icon: (
      <img
        ...
        alt="Metamask"
        className="max-w-full max-h-full scale-[3] object-contain"
      />
    ),
  },
];
...

  {
    ...
    icon: (
      <img
        ...
        alt="Firebase"
        className="max-w-full max-h-full scale-[2] object-contain"
      />
    ),
  },
...

  {
    ...
    icon: (
      <svg
        ...
        xmlns="http://www.w3.org/2000/svg"
        aria-label="Render"
        className=" scale-[1.5] pl-3 fill-current text-black dark:text-white"
      >
