...
const SkillsSection = () => {
...

    {
      ...
      icon: (
        <svg
          viewBox="0 0 170 32"
          fill="none"
          className="w-40 h-40 scale-[2] text-black dark:text-white"
        >
          <path
            fillRule="evenodd"
            clipRule="evenodd"
...

    {
      ...
      icon: (
        <svg
          ...
          class="text-primary scale-150 h:[30px] w-auto block"
          alt="Remix logo"
        >
...

    {
      ...
      icon: (
        <svg
          ...
          xmlns="http://www.w3.org/2000/svg"
          aria-label="Render"
          className=" scale-[2] fill-current text-black dark:text-white"
        >
  ...
  return (
    <section className="w-full px-8 md:px-16 lg:px-32 transition-all mt-16">
      <h1 className="text-4xl md:text-5xl font-medium mb-12 text-left mt-8">
        Skills
      </h1>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
        {skills.map((skill, index) => (
          <motion.div
            key={index}
            className="group relative flex flex-col items-center p-4 rounded-lg shadow-lg bg-white dark:bg-gray-900 hover:scale-105 transition-transform"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: index * 0.05 }}
          >
            <div className="flex items-center justify-center w-16 h-16 text-black dark:text-white">
              {skill.icon}
            </div>
            {skill.name && (
              <div className="absolute z-10 bottom-0 left-1/2 transform -translate-x-1/2 translate-y-full opacity-0 group-hover:opacity-100 transition-opacity overflow-hidden whitespace-nowrap w-full">
                <motion.span
                  className="bg-black text-white text-xs px-2 py-1 rounded inline-block w-max"
                  initial={{ x: "100%" }}
                  animate={{ x: "-100%" }}
